const ServiceAdvertisement = () => {
  return (
    <div>
      <div className="lg:ml-0 md:ml-16 ml-10 lg:mt-10 md:mt-10 mt-5 pb-10 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-12">
        ...
        {/* 4 */}
        <div className="card bg-base-300 w-72 dark:bg-slate-800 dark:text-white   shadow-xl lg:mb-0 md:mb-9 mb-8">
          <div className="card-body">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
